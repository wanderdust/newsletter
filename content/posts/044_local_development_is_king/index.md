...
date: '2026-02-26T08:27:51Z'
draft: false
summary: ''
tags: ['agentic development', 'productivity', 'ai']
categories: []
cover:
  image: ''
  alt: ''
...
It is the foundation that determines whether AI agents make you productive.

## What is a "good" development setup

Earlier I gave a description of what my ideal setup is. In my day to day I work with complex platforms, some of them have multiple microservices that interact with each other. Others might need to run data pipelines to build tables in the data warehouse
...
The local environment is the foundation for the agent to run and validate code which you use to create a feedback loop, which gives you automation. In the feedback loop you provide your agent a target to validate against. This can be anything you want, such as a unit tests, validating output artifacts or tables, or simply validating that the code runs without errors.
...
I’ve had success with this approach. After a year of using LLMs and agents, this is the first time I was able to automate some development work. But it only works if you have a good development setup and good specs. Without that, agents quickly become a time sink.
