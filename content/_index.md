...
stack: "Python and AWS, on Kubernetes. PostgreSQL, NoSQL, Trino, Spark and Databricks for data; Kong, AWS API Gateway, FastAPI and serverless infrastructure for APIs; Bedrock, SageMaker, MLflow and PyTorch for AI and ML. I build on solid foundations, so the specific tools are interchangeable."
