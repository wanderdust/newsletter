...
services:
  ...
  - title: "Applied AI & MLOps"
    body: "I build AI platforms and LLM-powered applications, with evaluation, monitoring, and guardrails in place. On MLOps, I build deployment pipelines with CI/CD, experiment tracking, and model promotion through config and code review."
  - title: "AI-Driven Development"
    body: "I build AI-driven development frameworks that set standards for how teams build with AI, grounded in engineering discipline: guardrails, code ownership, feedback loops, and testing. The latest is a high-stakes initiative now rolling out across engineering teams."
